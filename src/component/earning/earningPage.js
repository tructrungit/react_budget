        ...
        return (
            <div className="container">
                ...
                <div className="alert clearfix">
                    ...
                    {!this.props.isLoading && !this.props.isOpenForm && !this.state.monthlyEarning.date && <button type="button" onClick={() => this.addMonthlyEarning()} className="btn btn-warning btn-lg btn-block">Create Monthly Earning Item</button>}
                </div>
